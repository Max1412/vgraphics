...
namespace vg
{
    ...
    const auto g_resourcesPath = std::filesystem::current_path().parent_path().append("resources");
    const auto g_shaderPath = std::filesystem::current_path().parent_path().append("shaders");
